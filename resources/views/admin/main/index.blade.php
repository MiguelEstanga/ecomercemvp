...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-indigo-500">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $ordenes }}</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1">{{$ventas}}</p>
            {{-- <p class="text-xs text-red-500 mt-2">-2% esta semana</p> --}}
        </div>
        
        <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-yellow-500">
            <p class="text-sm font-medium text-gray-500">Productos Activos</p>
            <p class="text-3xl font-bold text-gray-900 mt-1">{{$productsActives}}</p>
