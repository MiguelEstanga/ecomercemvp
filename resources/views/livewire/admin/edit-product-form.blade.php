...
>
    <form id="edit-product-form" wire:submit.prevent="updateProduct" class="space-y-6 pb-20">
        ...
        {{-- Mensajes Flash dentro del modal --}}
        ...
        <div class="mb-4">
            ...
            <div class="relative inline-block">
                ...
                <button 
                    ...
                    class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600 shadow-lg transition-colors"
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">PNG, JPG, GIF - Máximo 2MB</p>
    ...
    <x-slot name="footer">
        <div class="flex justify-end space-x-3">
            ...
            <button 
                ...
                wire:target="updateProduct, imagen"
            >
                <span wire:loading.remove wire:target="updateProduct, imagen">
                    Actualizar Producto
                </span>
                <span wire:loading wire:target="updateProduct, imagen" class="flex items-center">
