            ...
            <div class="bg-white rounded-lg p-8 shadow-2xl">
                <div class="flex flex-col items-center space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <div class="animate-spin rounded-full h-16 w-16 border-4 border-indigo-500 border-t-transparent absolute inset-0"></div>
                    </div>
                    
                    {{-- Texto de carga --}}
                    <div class="text-center">
                        <p class="text-gray-800 font-semibold text-lg">Cargando...</p>
